...
WIDTH=1000
HEIGHT=562
bg_install=pygame.image.load("assets/images/running logo/background.png")
is_white=False
if is_white==False:
...
def get_calibri_font(size):
    return pygame.font.Font("assets/font/calibri.ttf", size)
def get_hanzi_font(size):
    return pygame.font.Font("assets/font/usehanzi.ttf", size)
def get_hanzijianti_font(size):
    return pygame.font.Font("assets/font/jianti (1).ttc", size)
def g1():
...
def restart_2():
    ...
    screen.fill((0, 0, 0))
    #windows logo
    login = Button(image=None, pos=(450,370),
                    text_input="准备就绪", font=font4, base_color="White", hovering_color="Gray")
    login.update(screen)
    windows_leftup=pygame.image.load("assets/images/running logo/win1.png")
    windows_rightup=pygame.image.load("assets/images/running logo/win2.png")
    windows_leftdown=pygame.image.load("assets/images/running logo/win3.png")
    windows_rightdown=pygame.image.load("assets/images/running logo/win4.png")
...
def hman_next():
    global running,bg_install   
    get=False
    globe=pygame.image.load("assets/images/running logo/human.svg")
    g1=Button(image=pygame.image.load("assets/images/running logo/global white un select.png"), pos=(350, 200),
              text_input="           自动设置", font=get_hanzijianti_font(20), base_color="Black", hovering_color="Black")
    networking=Button(image=pygame.image.load("assets/images/running logo/networkgood.png"), pos=(300, 200), text_input="", font=get_font(0), base_color="black", hovering_color="black")
    ...
    while running:
        ...
        system_choose=Button(image=pygame.image.load("assets/images/running logo/system choose white.png"), pos=(500, 281), text_input="", font=get_font(0), base_color="black", hovering_color="black")
        ...
        g1.update(screen)       
        next=Button(image=pygame.image.load("assets/images/running logo/next_button.png"), pos=(800, 450),
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if g1.checkForInput(OPTIONS_MOUSE_POS):
                    g1.image=pygame.image.load("assets/images/running logo/global white selected.png")
...
def hmanask():
    ...
    for i in range(1,35):
        startuplist.append(pygame.image.load(f"assets/images/startupv/startupv_{i}.png"))
        print(startuplist)
    crraima=0
...
def wifi_next():
    global running,bg_install   
    get=False
    globe=pygame.image.load("assets/images/running logo/network.svg")
    g1=Button(image=pygame.image.load("assets/images/running logo/global white un select.png"), pos=(350, 200),
...
def keyboard_next():
    global running,bg_install   
    get=False
    globe=pygame.image.load("assets/images/running logo/keyboard.svg")
    g1=Button(image=pygame.image.load("assets/images/running logo/global white un select.png"), pos=(350, 200),
...
def asking_next():
    global running,bg_install   
    get=False
    globe=pygame.image.load("assets/images/running logo/globe.svg")
    g1=Button(image=pygame.image.load("assets/images/running logo/global white un select.png"), pos=(340, 215),
              text_input="           中国大陆", font=get_hanzijianti_font(20), base_color="Black", hovering_color="Black")
    g2=Button(image=pygame.image.load("assets/images/running logo/global white un select.png"), pos=(660, 215),
              text_input="             中国台湾", font=get_hanzijianti_font(20), base_color="Black", hovering_color="Black")
    g3=Button(image=pygame.image.load("assets/images/running logo/global white un select.png"), pos=(340, 280),
              text_input="             中国香港", font=get_hanzijianti_font(20), base_color="Black", hovering_color="Black")
    g4=Button(image=pygame.image.load("assets/images/running logo/global white un select.png"), pos=(660, 280),
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if g2.checkForInput(OPTIONS_MOUSE_POS):
                    g2.image=pygame.image.load("assets/images/running logo/global white selected.png")
                if g3.checkForInput(OPTIONS_MOUSE_POS):
                    g3.image=pygame.image.load("assets/images/running logo/global white selected.png")
                if g4.checkForInput(OPTIONS_MOUSE_POS):
                    g4.image=pygame.image.load("assets/images/running logo/global white selected.png")
                if next.checkForInput(OPTIONS_MOUSE_POS):
                    keyboardask()
...
def restart():
    ...
    #windows logo
    login = Button(image=None, pos=(450,370),
                    text_input="正在进入设置", font=font4, base_color="White", hovering_color="Gray")
    login.update(screen)
    windows_leftup=pygame.image.load("assets/images/running logo/win1.png")
    windows_rightup=pygame.image.load("assets/images/running logo/win2.png")
    windows_leftdown=pygame.image.load("assets/images/running logo/win3.png")
...
def finishing_installation():
    ...
    while running:
        ...
        screen.fill("black")
        screen.blit(bg_install,(0,0))
        ins_image=pygame.image.load("assets/images/running logo/setup-icon.png")
...
def compressfile():
    ...
    while running:
        ...
        copyright2.changeColor(OPTIONS_MOUSE_POS)
        copyright2.update(screen)        
        img_image=pygame.image.load("assets/images/running logo/folder.png")
...
def prepareiso():
    ...
    while running:
        ...
        copyright2.changeColor(OPTIONS_MOUSE_POS)
        copyright2.update(screen)        
        img_image=pygame.image.load("assets/images/running logo/folder-box.png")
        imgbt=Button(image=img_image,pos=(270,300),
                     text_input=" ",font=get_font(1),base_color="white",hovering_color="white")
        imgbt.changeColor(OPTIONS_MOUSE_POS)
        imgbt.update(screen)
...
def delfile():
    ...
    while running:
        ...
        copyright2.changeColor(OPTIONS_MOUSE_POS)
        copyright2.update(screen)        
        img_image=pygame.image.load("assets/images/running logo/flie.png")
        imgbt=Button(image=img_image,pos=(270,300),
                     text_input=" ",font=get_font(1),base_color="white",hovering_color="white")
        imgbt.changeColor(OPTIONS_MOUSE_POS)
        imgbt.update(screen)
...
def install():
    ...
    while running:
        ...
        copyright2.changeColor(OPTIONS_MOUSE_POS)
        copyright2.update(screen)        
        img_image=pygame.image.load("assets/images/running logo/Disk2.png")
        imgbt=Button(image=img_image,pos=(270,300),
                     text_input=" ",font=get_font(1),base_color="white",hovering_color="white")
        imgbt.changeColor(OPTIONS_MOUSE_POS)
        imgbt.update(screen)
...
def choosedisk():
    ...
    while running:
        ...
        system_choose.update(screen)
        screen.blit(OPTIONS_TEXT, OPTIONS_RECT)
        disk=Button(image=pygame.image.load("assets/images/running logo/disk.png"), pos=(190, 200), text_input="", font=get_font(0), base_color="black", hovering_color="black")
...
def running_backup_files():
    ...
    while running:
        ...
        screen.blit(OPTIONS_TEXT, OPTIONS_RECT)
        ji=[
            pygame.image.load("assets/images/running logo/bar1.png"),
            pygame.image.load("assets/images/running logo/bar2.png"),
            pygame.image.load("assets/images/running logo/bar3.png"),
            pygame.image.load("assets/images/running logo/bar4.png"),
            pygame.image.load("assets/images/running logo/bar5.png"),
            ]
        draw_progress_bar(value)
        if value!=34.900000000000226:
            value += 0.1
...
def setup1():
    ...
    while running:
        ...
        copyright2.changeColor(OPTIONS_MOUSE_POS)
        copyright2.update(screen)
        login=Button(image=pygame.image.load("assets/images/running logo/next_button.png"), pos=(800, 450),
                     text_input="确定", font=get_hanzijianti_font(30), base_color="Black", hovering_color="White")
...
def start():
    ...
    login = Button(image=None, pos=(500,370),
                    text_input="安装程序正在启动", font=font4, base_color="White", hovering_color="Gray")
    login.update(screen)
    windows_leftup=pygame.image.load("assets/images/running logo/win1.png")
    windows_rightup=pygame.image.load("assets/images/running logo/win2.png")
    windows_leftdown=pygame.image.load("assets/images/running logo/win3.png")
